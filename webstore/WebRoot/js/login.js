$(function() {
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/webstore/images/login2.jpg");
		},
		function() {
			$("#submit").attr("src", "/webstore/images/login1.jpg");
		}
	);
	//主页图标变化
	$("#img2").hover(
			function() {
				$("#img2").attr("src", "/webstore/images/background1.jpg");
			},
			function() {
				$("#img2").attr("src", "/webstore/images/background3.jpg");
			}
		);
